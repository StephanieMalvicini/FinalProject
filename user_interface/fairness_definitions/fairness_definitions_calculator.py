...
class FairnessDefinitionsCalculatorUI:
    ...
    def dataset_parameters_confirmed(self, filename, outcome_name, test_size, decision_algorithm_name):
        try:
            if self.update_handlers(filename, outcome_name, test_size, decision_algorithm_name):
                ...
                required_parameters_names = self.parameters_handler.get_required_parameters_names()
                ...
                all_definitions = self.parameters_handler.get_all_definitions_names()
                self.definitions.update(available_definitions, all_definitions,
    ...
    def calculate(self, selected_definitions):
        try:
            ...
            parameters_values = self.parameters.get_parameters_values()
            ...
            result = self.calculator.calculate(selected_definitions)
