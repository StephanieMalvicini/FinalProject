...
from fairness_definitions.discrimination_basics import basic_metrics_calculator, probability_tables_calculator
...
from fairness_definitions.well_callibration import well_calibration
...
# se las muestro al usuario y elige el index, si es que existe
index = "Unnamed: 0"
...
metrics = basic_metrics_calculator(attributes_test, descriptions)
...
decimals = 1
positives_table, negatives_table = probability_tables_calculator(attributes_test, descriptions, decimals)
